...
void CConfig::SetConfig_Options(unsigned short val_iZone, unsigned short val_nZone) {
  ...
  /* DESCRIPTION: % Jet wall boundary marker(s)
   ...
   velocity_y, velocity_z, ... ) */
	addInletOption("MARKER_JET_WALL", nMarker_Jet_Wall, Marker_Jet_Wall, Jet_Frequency, Jet_Phase, Jet_Velocity);
  /* DESCRIPTION: Specified heat flux wall boundary marker(s)
   Format: ( Heat flux marker, wall heat flux (static), ... ) */
...
void CConfig::SetMarkers(unsigned short val_software, unsigned short val_izone) {
  ...
  nMarker_FlowLoad + nMarker_Pressure + nMarker_Custom + nMarker_Jet_Wall +
  ...
  iMarker_DV, iMarker_Moving, iMarker_Supersonic_Inlet, iMarker_Jet_Wall,
  ...
  nMarker_FlowLoad + nMarker_Custom + nMarker_Jet_Wall +
  ...
  for (iMarker_Jet_Wall = 0; iMarker_Jet_Wall < nMarker_Jet_Wall; iMarker_Jet_Wall++) {
		Marker_CfgFile_TagBound[iMarker_Config] = Marker_Jet_Wall[iMarker_Jet_Wall];
		Marker_CfgFile_KindBC[iMarker_Config] = JET_WALL;
		iMarker_Config++;
	}
...
void CConfig::SetOutput(unsigned short val_software, unsigned short val_izone) {
  ...
  iMarker_Moving, iMarker_Supersonic_Inlet, iMarker_ActDisk_Inlet, iMarker_Jet_Wall,
